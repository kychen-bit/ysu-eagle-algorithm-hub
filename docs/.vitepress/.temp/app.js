...
const siteData = deserializeFunctions(JSON.parse('{"lang":"zh-CN","dir":"ltr","title":"燕鹰算法知识库","description":"汇聚 RoboMaster 算法资料，连接学习、实践与传承","base":"/","head":[],"router":{"prefetchLinks":true},"appearance":true,"themeConfig":{"logo":{"light":"/assets/brand/ysu-eagle-mark-blue.png","dark":"/assets/brand/ysu-eagle-mark-dark.png","alt":"燕鹰战队标志"},"siteTitle":"燕鹰算法知识库","nav":[{"text":"开始学习","link":"/learning-path/"},{"text":"知识库","link":"/knowledge/"},{"text":"项目手册","link":"/projects/"},{"text":"技术博客","link":"/blog/"},{"text":"资源导航","link":"/resources/"},{"text":"参与共建","link":"/contribute/"}],"sidebar":{"/learning-path/":[{"text":"学习路线","items":[{"text":"路线总览","link":"/learning-path/"},{"text":"0 · 准备与环境","link":"/learning-path/stage-0"},{"text":"1 · Linux、Git 与 C++","link":"/learning-path/stage-1"},{"text":"2 · OpenCV 与相机","link":"/learning-path/stage-2"},{"text":"3 · 装甲板识别","link":"/learning-path/stage-3"},{"text":"4 · PnP 与坐标系","link":"/learning-path/stage-4"},{"text":"5 · 预测与通信","link":"/learning-path/stage-5"},{"text":"6 · 部署与维护","link":"/learning-path/stage-6"}]}],"/knowledge/":[{"text":"知识库","items":[{"text":"全部分类","link":"/knowledge/"},{"text":"开发环境","link":"/knowledge/environment"},{"text":"Linux 与工程工具","link":"/knowledge/linux-tools"},{"text":"C++ 与构建系统","link":"/knowledge/cpp-build"},{"text":"视觉与相机","link":"/knowledge/vision-camera"},{"text":"深度学习","link":"/knowledge/deep-learning"},{"text":"通信与部署","link":"/knowledge/communication-deploy"}]},{"text":"精选原文","collapsed":true,"items":[{"text":"Ubuntu 入门","link":"/knowledge/imported/qd/Introduction_to_Linux/hello_ubuntu"},{"text":"Linux 基本命令","link":"/knowledge/imported/qd/Introduction_to_Linux/Basic_commands"},{"text":"Git 基础","link":"/knowledge/imported/qd/Introduction_to_Linux/Git"},{"text":"C++11 语法","link":"/knowledge/imported/qd/Technical_Basics_and_Development_Techniques/C++11_grammar"},{"text":"Eigen","link":"/knowledge/imported/qd/Technical_Basics_and_Development_Techniques/Eigen"},{"text":"OpenCV 配置","link":"/knowledge/imported/qd/environment_configuration/OpenCV"},{"text":"相机标定","link":"/knowledge/imported/qd/Project_Tutorial/camera_calibration"}]}],"/projects/":[{"text":"项目手册","items":[{"text":"项目总览","link":"/projects/"},{"text":"公开手册模板","link":"/projects/template"},{"text":"最小视觉项目","link":"/projects/minimal-vision"}]}],"/blog/":[{"text":"技术博客","items":[{"text":"最新文章","link":"/blog/"},{"text":"视觉课程综述","link":"/blog/imported/sjtu/2020-09-05-vision-learning-1-overview"},{"text":"相机与标定","link":"/blog/imported/sjtu/2021-10-10-vision-learning-2"},{"text":"装甲板调参经验","link":"/blog/imported/sjtu/2023-05-16-rm-cv-std-how-to-adjust-parameters"}]}],"/resources/":[{"text":"资源导航","items":[{"text":"资源总览","link":"/resources/"},{"text":"开源项目","link":"/resources/open-source"},{"text":"其他战队资料","link":"/resources/teams"}]}],"/contribute/":[{"text":"参与共建","items":[{"text":"投稿指南","link":"/contribute/"},{"text":"写作规范","link":"/contribute/writing-guide"},{"text":"转载与版权","link":"/contribute/copyright"}]}]},"search":{"provider":"local","options":{"locales":{"root":{"translations":{"button":{"buttonText":"搜索资料","buttonAriaLabel":"搜索资料"},"modal":{"noResultsText":"没有找到相关资料","resetButtonTitle":"清除查询","footer":{"selectText":"选择","navigateText":"切换","closeText":"关闭"}}}}}}},"outline":{"level":[2,3],"label":"本页内容"},"docFooter":{"prev":"上一篇","next":"下一篇"},"lastUpdated":{"text":"最后更新"},"editLink":{"pattern":"https://github.com/YSU-Eagle/ysu-eagle-algorithm-hub/edit/main/docs/:path","text":"编辑此页"},"socialLinks":[{"icon":"github","link":"https://github.com/YSU-Eagle"}],"footer":{"message":"公开资料仅供学习交流；转载内容版权归原作者所有。","copyright":"燕山大学 RoboMaster 燕鹰战队算法组"}},"locales":{},"scrollOffset":134,"cleanUrls":true}'));
...
const _sfc_main$w = /* @__PURE__ */ defineComponent({
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const VPLocalSearchBox = defineAsyncComponent(() => import("./VPLocalSearchBox.Ce4M-sQr.js"));
...
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      if (typeLabel.value || unref(frontmatter).authors || unref(frontmatter).updated) {
        _push(`<div${ssrRenderAttrs(mergeProps({ class: "article-meta" }, _attrs))}>`);
        if (typeLabel.value) {
          _push(`<span class="article-meta__type">${ssrInterpolate(typeLabel.value)}</span>`);
        } else {
          _push(`<!---->`);
        }
        if (unref(frontmatter).authors) {
          _push(`<span>作者：${ssrInterpolate(Array.isArray(unref(frontmatter).authors) ? unref(frontmatter).authors.join("、") : unref(frontmatter).authors)}</span>`);
        } else {
          _push(`<!---->`);
        }
        if (updatedLabel.value) {
          _push(`<span>更新：${ssrInterpolate(updatedLabel.value)}</span>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div>`);
...
_sfc_main$3.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add(".vitepress/theme/components/ArticleMeta.vue");
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const { frontmatter } = useData$1();
    return (_ctx, _push, _parent, _attrs) => {
      if (unref(frontmatter).source_url) {
        _push(`<aside${ssrRenderAttrs(mergeProps({ class: "source-notice" }, _attrs))}><span class="source-notice__label">来源说明</span><p> 本文转载或整理自 <a${ssrRenderAttr("href", unref(frontmatter).source_url)} target="_blank" rel="noreferrer">${ssrInterpolate(unref(frontmatter).source_project || "原始资料")}</a>`);
        if (unref(frontmatter).license) {
          _push(`<!--[-->，上游许可证为 ${ssrInterpolate(unref(frontmatter).license)}<!--]-->`);
        } else {
          _push(`<!---->`);
        }
        _push(`。 内容的页面结构与资源路径可能为适配本站而调整。 </p></aside>`);
      } else {
        _push(`<!---->`);
      }
    };
...
_sfc_main$2.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add(".vitepress/theme/components/SourceNotice.vue");
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const stages = [
      ["00", "准备与环境", "建立 Linux 开发环境，学会提问与记录。", "/learning-path/stage-0"],
      ["01", "工程基础", "掌握 Git、C++ 与 CMake 的协作底座。", "/learning-path/stage-1"],
      ["02", "视觉入门", "从图像、相机到 OpenCV 的最小闭环。", "/learning-path/stage-2"],
      ["03", "目标识别", "完成装甲板检测与基础分类实践。", "/learning-path/stage-3"],
      ["04", "空间解算", "理解坐标系、PnP、标定与弹道。", "/learning-path/stage-4"],
      ["05", "系统联调", "连接预测、控制、通信与整车协作。", "/learning-path/stage-5"]
    ];
    const topics = [
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<main${ssrRenderAttrs(mergeProps({ class: "hub-home" }, _attrs))}><section class="hero-manual"><div class="hero-manual__copy"><p class="eyebrow">YSU EAGLE · ALGORITHM GROUP</p><h1>把散落的经验，<br><em>编成一条可走的路。</em></h1><p class="hero-manual__lead">燕鹰算法知识库汇聚 RoboMaster 算法资料，连接学习、实践与传承。从一台空白电脑开始，走到能够部署、调试并维护一个真实视觉系统。</p><div class="hero-manual__actions"><a class="button-primary"${ssrRenderAttr("href", unref(withBase)("/learning-path/"))}>从学习路线开始</a><a class="button-quiet"${ssrRenderAttr("href", unref(withBase)("/knowledge/"))}>浏览全部资料 →</a></div></div><div class="hero-manual__mark" aria-label="燕鹰战队标志"><img${ssrRenderAttr("src", unref(withBase)("/assets/brand/ysu-eagle-logo-blue.png"))} alt="燕鹰战队 YSU 标志"><div class="hero-manual__index"><span>FIELD MANUAL</span><strong>2026 / 01</strong></div></div></section><section class="home-section route-section"><header class="section-heading"><div><span>01</span><p>学习路线</p></div><h2>不是文章列表，<br>是一套训练次序。</h2><a${ssrRenderAttr("href", unref(withBase)("/learning-path/"))}>查看完整路线 →</a></header><div class="stage-list"><!--[-->`);
      ssrRenderList(stages, (stage) => {
        _push(`<a${ssrRenderAttr("href", unref(withBase)(stage[3]))} class="stage-row"><span class="stage-row__number">${ssrInterpolate(stage[0])}</span><strong>${ssrInterpolate(stage[1])}</strong><p>${ssrInterpolate(stage[2])}</p><span aria-hidden="true">→</span></a>`);
      });
      _push(`<!--]--></div></section><section class="home-section topic-section"><header class="section-heading section-heading--compact"><div><span>02</span><p>技术专题</p></div><h2>按问题查找，<br>按项目落地。</h2></header><div class="topic-grid"><!--[-->`);
      ssrRenderList(topics, (topic, index) => {
        _push(`<a${ssrRenderAttr("href", unref(withBase)(topic[2]))} class="topic-block"><span>0${ssrInterpolate(index + 1)}</span><h3>${ssrInterpolate(topic[0])}</h3><p>${ssrInterpolate(topic[1])}</p><b>进入专题 →</b></a>`);
      });
      _push(`<!--]--></div></section><section class="home-section dispatch-section"><div class="dispatch-title"><p class="eyebrow">LATEST DISPATCH</p><h2>把踩过的坑，<br>留在下一次出发之前。</h2></div><div class="dispatch-list"><a${ssrRenderAttr("href", unref(withBase)("/blog/imported/sjtu/2023-05-16-rm-cv-std-how-to-adjust-parameters"))}><time>2023.05.16</time><strong>装甲板识别调参经验</strong><span>转载 · 视觉</span></a><a${ssrRenderAttr("href", unref(withBase)("/blog/imported/sjtu/2021-10-10-vision-learning-2"))}><time>2021.10.10</time><strong>相机模型与相机标定</strong><span>转载 · 课程</span></a><a${ssrRenderAttr("href", unref(withBase)("/blog/imported/sjtu/2020-09-05-vision-learning-1-overview"))}><time>2020.09.05</time><strong>RoboMaster 视觉综述</strong><span>转载 · 入门</span></a></div><a class="button-quiet"${ssrRenderAttr("href", unref(withBase)("/blog/"))}>阅读全部文章 →</a></section><section class="home-section contribution-strip"><div><span>03</span><p>持续共建</p></div><h2>文档不是交付物，<br>是协作发生的地方。</h2><p>通过 Markdown 和 Pull Request 投稿。每一次修正、补充和复盘，都会成为下一届队员的起点。</p><a class="button-primary"${ssrRenderAttr("href", unref(withBase)("/contribute/"))}>查看投稿方式</a></section></main>`);
    };
  }
});
const _sfc_setup = _sfc_main.setup;
...
const RawTheme = {
  extends: theme,
  enhanceApp({ app }) {
    app.component("HomePage", _sfc_main);
    app.component("ArticleMeta", _sfc_main$3);
    app.component("SourceNotice", _sfc_main$2);
  },
  Layout: _sfc_main$1
};
