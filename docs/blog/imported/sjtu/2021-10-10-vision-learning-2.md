...
2. 按照视角大小分类
	...
	* 标准
    ...
    ![坐标系示意图](/assets/sjtu-vision-camera/1633799583875.png)
...
下面为组装好的摄像机图片。
![坐标系方向示意图](/assets/sjtu-vision-camera/1633801262981.png)
![右手坐标系示意图](/assets/sjtu-vision-camera/1633801349099.png)

### 相机成像模型
![相机成像示意图](/assets/sjtu-vision-camera/1633803621462.png)
...
![像素坐标系示意图](/assets/sjtu-vision-camera/1633804990347.png)
...
![针孔相机模型](/assets/sjtu-vision-camera/1633806680436.png)
...
![相机坐标变换](/assets/sjtu-vision-camera/1633816100640.png)
...
* 径向畸变
	...
	* 径向畸变导致的图像会产生如下图的扭曲
	...
	![棋盘格标定板](/assets/sjtu-vision-camera/1633808831820.png)
	
	* 其示意图如图
	
	![标定图像示例](/assets/sjtu-vision-camera/1633808950784.png)
...
* 切向畸变
	...
	* 其示意图如图
	...
	![棋盘格角点检测](/assets/sjtu-vision-camera/1633809069362.png)
...
![标定结果示例](/assets/sjtu-vision-camera/1633810922541.png)
